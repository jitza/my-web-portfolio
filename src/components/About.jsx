    ...
    <div className="h-screen w-full flex items-center bg-gradient-to-b from-slate-900 to-gray-900 text-gray-500">
      <section className="text-center md:px-32">
        ...
        <p className="px-12 md:text-xl">
          ...
          development, as a graphic designer, I’m involved in creating marketing
          designs. In addition, game development is a self-taught skill I’ve
          acquired by programming in my free time. I have programmed a couple of
          games that simulate traditional games, and I’ve also developed other
          working prototypes. I am committed to developing my skills and
          exploring every facet of the IT industry.
        </p>
      </section>
    </div>
  );
